...
const TITLE = 'Jager Titan Builder'
...
const TitanModelWhite = () => {
  const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL+'/models/TitanWhite.gltf');
  return (
    <>
...
const TitanModelBlue = () => {
  const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL+'/models/TitanBlue.gltf');
  return (
    <>
      <primitive object={gltf.scene} />
    </>
...
const TitanModelRed = () => {
  const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL+'/models/TitanRed.gltf');
  return (
    <>
      <primitive object={gltf.scene} />
    </>
...
const TitanModelGrey = () => {
  const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL+'/models/TitanGrey.gltf');
  return (
    <>
      <primitive object={gltf.scene} />
    </>
...
const TitanModelOrange = () => {
  const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL+'/models/TitanOrange.gltf');
  return (
    <>
      <primitive object={gltf.scene} />
    </>
...
const TitanModelGold = () => {
  const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL+'/models/TitanGold.gltf');
  return (
    <>
      <primitive object={gltf.scene} />
    </>
...
export default function Viewer() {
  ...
  const handleClose = () => setOpen(false);
    ...
    var [showOrangeCar, setOrangeShowCar] = React.useState(true);
    ...
    label: 'Paint',
        ...
        <Typography>{}</Typography>
          ...
          <Grid container item direction="row">
               ...
               <input type="radio" value="5" name="colorSelect" id="paintOption5" onClick={() => { SelectOrangeClick(); OrangeSwitcher() }} defaultChecked></input>
  ...
  return (  
    ...
    <Canvas className={classes.Viewport} id="c" shadows={true} dpr={[1, 2]} camera={{ fov: 40 }}>
      <Suspense fallback={Loader}>
        ...
        { showWhiteCar ? <TitanModelWhite/> : null }
        { showBlueCar ? <TitanModelBlue/> : null }
        { showRedCar ? <TitanModelRed/> : null }
        { showGreyCar ? <TitanModelGrey/> : null }
        { showOrangeCar ? <TitanModelOrange/> : null }
        { showGoldCar ? <TitanModelGold/> : null }       
        </Stage>
...
<Box className={classes.StepperBox}>
        <Stepper className={classes.Stepper} activeStep={activeStep} orientation="vertical">
          ...
          <div className={classes.LogoContainer}>
           <img alt='Titan Logo' className={classes.TitanLogo} src={TitanLogo}/>
          </div>
      ...
      <Grid container>
        ...
        <Button href={'/TitanConfigurator'} className={classes.ResetButton} sx={{ mt: 1, mr: 1, }}> Reset Configuration </Button> 
          </Grid>
        ...
        <Fade in={open}>
          ...
          <Grid container sx={{ m:2 }}>         
              ...
              <Grid item container direction='column' className={classes.Final}>
                  ...
                  <Button onClick={handleOpen}  variant="contained" type='submit' className={classes.OrderButton} disabled>Place Orderd</Button>
              </Grid>
            </Grid>
            </form>
            </Grid>
