...
import BlackPaint from '../res/colors/Black.png'
import GreyPaint from '../res/colors/Grey.png'
import WhitePaint from '../res/colors/White.png'
import GoldPaint from '../res/colors/Gold.png'

const TITLE = "Jager Apex Builder"
...
const ApexModelWhite = () => {
  const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL+'/models/ApexWhite.gltf');
  return (
    <>
...
const ApexModelBlue = () => {
  const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL+'/models/ApexBlue.gltf');
  return (
    <>
      <primitive object={gltf.scene} />
    </>
...
const ApexModelRed = () => {
  const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL+'/models/ApexRed.gltf');
  return (
    <>
      <primitive object={gltf.scene} />
    </>
...
const ApexModelGrey = () => {
  const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL+'/models/ApexGrey.gltf');
  return (
    <>
      <primitive object={gltf.scene} />
    </>
...
const ApexModelBlack = () => {
  const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL+'/models/ApexBlack.gltf');
  return (
    <>
      <primitive object={gltf.scene} />
    </>
...
const ApexModelGold = () => {
  const gltf = useLoader(GLTFLoader, process.env.PUBLIC_URL+'/models/ApexGold.gltf');
  return (
    <>
      <primitive object={gltf.scene} />
    </>
...
export default function Viewer() {
  ...
  const handleClose = () => setOpen(false);
    ...
    var [showWhiteCar, setWhiteShowCar] = React.useState(false); 
    var [showBlueCar, setBlueShowCar] = React.useState(false);
    var [showRedCar, setRedShowCar] = React.useState(false);
    var [showGreyCar, setGreyShowCar] = React.useState(true);
    var [showBlackCar, setBlackShowCar] = React.useState(false);
    var [showGoldCar, setGoldShowCar] = React.useState(false);
    ...
    const SelectBlackClick = () => setBlackShowCar(true)
    const SelectGoldClick = () => setGoldShowCar(true)
  ...
  function WhiteSwitcher() {
      ...
      showGreyCar=(false)
      setBlackShowCar(false)
      showBlackCar=(false)
      setGoldShowCar(false)
      showGoldCar=(false)
      }
    ...
    label: 'Paint',
        ...
        <Typography>{}</Typography>
          <Grid container item direction="row">                        
               <input type="radio" value="1" name="colorSelect" id="paintOption1" onClick={() => { SelectWhiteClick(); WhiteSwitcher()}}></input>
          ...
          <Grid container item direction="row">
               <input type="radio" value="4" name="colorSelect" id="paintOption4" onClick={() => { SelectGreyClick(); GreySwitcher()}} defaultChecked></input>
                  <label for="paintOption4" class="paintOption paintOption4">
                    <img class="paint" alt="Grey Paint" src={GreyPaint}></img>
                  </label>
               <input type="radio" value="5" name="colorSelect" id="paintOption5" onClick={() => { SelectBlackClick(); BlackSwitcher()}}></input>
                  <label for="paintOption5" class="paintOption paintOption5">
                    <img class="paint" alt="Black Paint" src={BlackPaint}></img>
                  </label>
               <input type="radio" value="6" name="colorSelect" id="paintOption6" onClick={() => { SelectGoldClick(); GoldSwitcher()}}></input> 
                  <label for="paintOption6" class="paintOption paintOption6">
                    <img class="paint" alt="Gold Paint" src={GoldPaint}></img>
                  </label> 
          </Grid>
        </Grid>
        </form>,
  ...
  return (   
    ...
    <Canvas className={classes.Viewport} id="c" shadows={true} dpr={[1, 2]} camera={{ fov: 40 }}>
      <Suspense fallback={Loader}>
        ...
        { showWhiteCar ? <ApexModelWhite/> : null }
        { showBlueCar ? <ApexModelBlue/> : null }
        { showRedCar ? <ApexModelRed/> : null }
        { showGreyCar ? <ApexModelGrey/> : null }
        { showBlackCar ? <ApexModelBlack/> : null }
        { showGoldCar ? <ApexModelGold/> : null }       
        </Stage>
      ...
      <Box className={classes.StepperBox}>
        <Stepper className={classes.Stepper} activeStep={activeStep} orientation="vertical">
          ...
          <div className={classes.LogoContainer}>
           <img alt='Apex Logo' className={classes.ApexLogo} src={ApexLogo}/>
          </div>
      ...
      <Grid container>
        ...
        <Button href={'/ApexConfigurator'} className={classes.ResetButton} sx={{ mt: 1, mr: 1, }}> Reset Configuration </Button> 
          </Grid>
